...
![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/task_id_29_migration_of_database_using_dms_(1).png)
...
1.  Launch the lab environment by clicking on ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/start_lab.png). Please wait until the lab environment is provisioned. It will take less than 2 minutes to provision the lab environment.

2.  Once the Lab is started, you will be provided with***IAM user name***, ***Password***, **AccessKey** and ***Secret Access Key***.

3.  Click on the ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/open_console.png), AWS Management Console will open in a new tab.
...
**Note : **If you face any issues, please go through [**FAQs and Troubleshooting for Labs**](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/faqs-and-troubleshooting).
...
2.  Navigate to ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/image29.png) on the left panel and click on **Launch Instance**

1.  **Choose an Amazon Machine Image (AMI):** Search for ***Ubuntu Server*** and select **Ubuntu Server ****18.04**

**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/ubuntu-server-screenshot.png)**

**Note: If you do not select the mentioned version, you will run into errors while executing few commands.**

1.  **Choose an Instance Type:** select ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/t2-micro-screenshot.png), click on the ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/configure-instance-details-button.png).
...
2.  In **Configure Instance Details **Page:
    ...
    -   Leave everything else as default and click on ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/add-storage-button.png)

3.  **Add Storage Page :** No changes needed. Click on ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/add-tags-button.png).

4.  **Add Tags Page**

    -   Click on ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/add-tag2-button.png)

    -   Key    : Enter ***Name***

    -   Value    : Enter ***SourceEC2Instance***

    -   Click on ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/configure-security-group-button.png)
...
5.  On the **Configure Security Group** page:
    ...
    -   To add **SSH**,
        ...
        -   Choose Type    : ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/ssh-dropdown.png)

        -   Source        : ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/anywhere-dropdown.png)

    -   For **MYSQL/Aurora,**

        -   Click on ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/add-rule-button.png)
...
-   Please follow the steps in [SSH into EC2 Instance](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/ssh-into-ec-instance).
...
**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli1.png)**
...
3.  Now, we have to set the password for the root user. Please keep a note of this password as we will use this in upcoming steps. To set the default password,  please run the below-provided commands one by one:
    ...
    -   Now start MySQL using : **mysqld_safe --skip-grant-tables&**
        ...
        **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/logg_enter.png)**
    ...
    -   Now we must stop all services before starting again by using : **sudo killall -u mysql**
        ...
        **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/sudo_kill.png)**
...
5.  After successful login, you will be able to see the welcome message and **mysql>** prompt waiting for your command:
    ...
    **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli2.png)**
...
**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli3.png)**

**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli4.png)**
...
1.  Click on the ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/console-services-button.png) and select the RDS under the ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/database.png) section.
...
1.  Click on**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/console-services-button.png)** and then choose Database Migration Service under the **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/migration_&_transfer.png)****.**
...
4.  In the **Replication instance configuration **section,
    ...
    -   Instance class                : Select **dms.t2.micro\
        ...
        ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/instance_class.png)**
...
![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/replication-screenhot.png)
...
![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/details.png)
...
-   Follow the below steps to complete** Endpoint type:**
    ...
    -   Select endpoint as **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/source-endpoint.png)**
...
![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/source_succesful.png)
...
2.  Follow the below steps to complete** Endpoint type:**
    ...
    -   Select endpoint as **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/target-endpoint.png)**
...
5.  **Test endpoint connection:**
    ...
    -   Click on **Run test **to test the connection.![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/target_success.png)
...
**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli5.png)**

-   View the database created

    -   **show databases;**

**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli6.png)**

1.  Switch the database **SchoolDB.**

    -   **use SchoolDB;**

**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli7.png)**
...
**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli8.png)**

1.  See the **student** table.

    -   **show tables;**

![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli9.png).
...
2.  Check the items added in the Table
    ...
    -   **select * from students;**
        ...
        **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli10.png)**
...
**![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli11.png)**
...
1.  Navigate to AWS DMS console and click on the ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/database_migration_task.png).
...
4.  Create a database migration task:
    ...
    -   Table mappings:
        ...
        -   Selection rules        : ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/add_new_secton_rule.png)
...
1.  Navigate to![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/database_migration_task_48_36.png)in left panel of DMS page.

2.  If you followed all the previous steps correctly, it will show the migration task status as![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/load_complete.png)
...
![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli12_49_21.png)

1.  Run command: 

    -   **use SchoolDB;**

        **![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli13.png)**

1.  Run command: 

    -   **show tables;**

        ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli14.png)

2.  Run command:

    -   **select * from students;**

        ![](https://raw.githubusercontent.com/hoabka/saa-c02-labs/master/rds-labs/images/dms/cli15.png) 
